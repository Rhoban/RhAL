...
public:
   ...
   * and its name
   */
  virtual void onNewRegister(id_t id, const std::string& name) = 0;
   ...
   * Device id and name.
   */
  virtual void forceRegisterRead(id_t id, const std::string& name) = 0;
  virtual void forceRegisterWrite(id_t id, const std::string& name) = 0;
