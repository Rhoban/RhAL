...
RX::RX(const std::string& name, id_t id) :
    ...
    _complianceMarginCW("complianceMarginCW", 0x1A, 1, convEncode_ComplianceMargin, convDecode_ComplianceMargin, 0, true),
    _complianceMarginCCW("complianceMarginCCW", 0x1B, 1, convEncode_ComplianceMargin, convDecode_ComplianceMargin, 0, true),
