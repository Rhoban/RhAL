...
class IMU : public Device
{
    public:
        ...
        inline IMU(const std::string& name, id_t id) :
			...
			_yaw("yaw", 0x24, 2, convEncode_2Bytes, convDecode_100th_degrees, 0),
			_pitch("pitch", 0x26, 2, convEncode_2Bytes, convDecode_100th_degrees, 0),
			_roll("roll", 0x28, 2, convEncode_2Bytes, convDecode_100th_degrees, 0),
			_accX("accX", 0x2A, 2, convEncode_2Bytes, convDecode_2Bytes, 0),
			_accY("accY", 0x2C, 2, convEncode_2Bytes, convDecode_2Bytes, 0),
			_accZ("accZ", 0x2E, 2, convEncode_2Bytes, convDecode_2Bytes, 0),
			_gyroX("gyroX", 0x30, 2, convEncode_2Bytes, convDecode_gyro, 0),
			_gyroY("gyroY", 0x32, 2, convEncode_2Bytes, convDecode_gyro, 0),
			_gyroZ("gyroZ", 0x34, 2, convEncode_2Bytes, convDecode_gyro, 0),
			_gyroYaw("gyroYaw", 0x36, 2, convEncode_2Bytes, convDecode_100th_degrees, 0),
			_magnX("magnX", 0x38, 2, convEncode_2Bytes, convDecode_2Bytes, 0),
			_magnY("magnY", 0x3A, 2, convEncode_2Bytes, convDecode_2Bytes, 0),
			_magnZ("magnZ", 0x3C, 2, convEncode_2Bytes, convDecode_2Bytes, 0),
			_magnAzimuth("magnAzimuth", 0x3E, 2, convEncode_2Bytes, convDecode_100th_degrees, 0)
        {
		}
