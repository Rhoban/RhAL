...
int main(int argc, char** argv)
{
  ...
  std::cout << "Protocol config: port=" << port.getValue() << " speed=" << speed.getValue()
            << " protocol=" << protocol.getValue() << std::endl;
  ...
  if (config.getValue() != "")
  {
    std::cout << "Reading RhAL configuration: " << config.getValue() << std::endl;
